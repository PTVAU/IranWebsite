            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {  // language settings
                        "sProcessing": '<img src="' + Helper.getGlobalImgPath() + 'loading-spinner-grey.gif"/><span>&nbsp;&nbsp;Loading...</span>',
                    ...
                    "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                      oSettings.jqXHR = $.ajax( {
                        ...
                        "success": function(res, textStatus, jqXHR) {
                            if (res.sMessage) {
                                Helper.alert({type: (res.sStatus == 'OK' ? 'success' : 'danger'), icon: (res.sStatus == 'OK' ? 'check' : 'warning'), message: res.sMessage, container: tableWrapper, place: 'prepend'});
                            } 
                            if (res.sStatus) {
                        ...
                        "error": function() {
                            ...
                            Helper.alert({type: 'danger', icon: 'warning', message: tableOptions.dataTable.oLanguage.sAjaxRequestGeneralError, container: tableWrapper, place: 'prepend'});
                    ...
                    "fnDrawCallback": function( oSettings ) { // run some code on table redraw
                        ...
                        Helper.initUniform($('input[type="checkbox"]', table));  // reinitialize uniform checkboxes on each table reload
