var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        function initJcrop()//{{{
        {
          ...
          $('#demo5').Jcrop({
            ...
            Helper.updateUniform('#can_click,#can_move,#can_size');

            $('#ar_lock,#size_lock,#bg_swap').attr('checked',false);
            Helper.updateUniform('#ar_lock,#size_lock,#bg_swap');
        ...
        function releaseCheck()
        {
          ...
          Helper.updateUniform('#can_click');
        };
    ...
    return {
        ...
        init: function () {
            ...
            Helper.addResizeHandler(handleResponsive);
            handleResponsive();
