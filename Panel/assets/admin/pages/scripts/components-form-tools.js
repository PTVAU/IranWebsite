var ComponentsFormTools = function () {
    ...
    var handleBootstrapMaxlength = function() {
        ...
        $('#maxlength_placement').maxlength({
            limitReachedClass: "label label-danger",
            alwaysShow: true,
            placement: Helper.isRTL() ? 'top-right' : 'top-left'
        });
    }
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function (e) {
            ...
            if (input.val() === "") {
                ...
                pop.popover('destroy');
                pop.popover({
                    'placement': (Helper.isRTL() ? 'left' : 'right'),
                    'html': true,
                    'container': 'body',
                ...
                // set last poped popover to be closed on click(see Helper.js => handlePopovers function)     
                Helper.setLastPopedPopover(pop);
                pop.popover('show');
        ...
        $("#username2_input").change(function () {
            ...
            $.post('demo/username_checker.php', {
                ...
                if (res.status == 'OK') {
                    ...
                    Helper.setLastPopedPopover(input);
                }
